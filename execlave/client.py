...
class Execlave:
    ...
    def register_agent(
            ...
            try:
                ...
                for a in agents:
                    if a.get("agentId") == agent_id:
                        ...
                        return agent
                # Fallback: search by name if agent_id search didn't match
                if name:
        ...
        agent = Agent(self, data.get("data", data))
        self._agents[agent_id] = agent
        return agent
        ...
        *,
        ...
        if func is not None and callable(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                t = Trace(self, agent_id=resolved_agent_id, session_id=session_id, user_id=user_id, metadata=metadata)
                try:
