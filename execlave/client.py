...
class Execlave:
    ...
    def _cache_key(
        ...
        # metadata included or not. default=str guarantees this never raises
        # for an exotic value; it only needs to differentiate, not exactly
        # match the server's canonical hash.
        try:
            extra = json.dumps([metadata, estimated_cost, tools], sort_keys=True, default=str)
    ...
    def enforce_policy(
        ...
        *,
        ...
        cache_key = self._cache_key(
            agent_id, input, effective_environment, metadata, estimated_cost, tools
        )
